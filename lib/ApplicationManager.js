...
ApplicationManager.prototype.getApp = function(appID) {
    if (this.applications.hasOwnProperty(appID)) return this.applications[appID];

    var appName = appID; // Maybe they are trying by name
    var app = _.find(this.applications, function(_app) {
...
ApplicationManager.prototype.hasFocus = function(appID) {
    return appID == this.focusedAppID;
}
