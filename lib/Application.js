...
Application.prototype.grabFocus = function() {
    var hasFocus = AppManager.hasFocus(this.appID);
    if (!hasFocus) {
...
Application.prototype.setTitle = function(win_id, value) {
    this.window_manager.setTitle(win_id, value);
}
