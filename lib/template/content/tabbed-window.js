if (Meteor.isClient) {
    Template.AppManagerTabbedWindow.helpers({
        paneTree : function() {
    ...
    //     Panes code       //
    // -------------------- //
    Template.AppManagerTabbedWindowPanes.helpers({
    ...
    Template.AppManagerTabbedWindowPaneDividerVertical.rendered = function() {
        paneDividerRegistrar($(this.findAll('.pane-divider')));
    }

    Template.AppManagerTabbedWindowPaneDividerHorizontal.rendered = function() {
        paneDividerRegistrar($(this.findAll('.pane-divider')));
    }
    ...
    Template.AppManagerTabbedWindowPaneContent.rendered = function() {
    ...
    Template.AppManagerTabbedWindowPaneContent.helpers({
        tabs : function() {
    ...
    //       Tab code       //
    // -------------------- //
    Template.AppManagerTabbedWindowPaneTabHeader.rendered = function() {
    ...
    Template.AppManagerTabbedWindowPaneTabHeader.helpers({
        isActive : function() {
            return this.active;
        }
    });

    Template.AppManagerTabbedWindowPaneTabBody.helpers({
